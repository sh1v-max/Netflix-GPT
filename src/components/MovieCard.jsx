...
const MovieCard = ({ posterPath }) => {
  ...
  return (
    <div className="w-24 md:w-48 relative py-2 group">
      <div className="rounded-sm md:rounded-lg overflow-hidden shadow-md transform transition duration-300 group-hover:scale-102 group-hover:z-20 relative">
        <img
