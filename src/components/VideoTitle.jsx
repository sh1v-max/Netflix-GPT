...
const VideoTitle = ({ title, overview }) => {
  return (
    <div className="absolute top-70 left-2 right-2 md:top-70 md:left-5 w-[400px] md:w-[600px] h-full md:bg-gradient-to-r  flex flex-col text-white md:justify-center z-20">
      <div className='p-1'>
        <h1 className="text-xl md:text-4xl lg:text-5xl font-bold mb-3 md:mb-6 drop-shadow-lg">{title}</h1>
        <p className="text-[12px] md:text-base max-w-xl mb-4 md:mb-6 line-clamp-3 md:line-clamp-none drop-shadow-md">{overview}</p>
